...
from nets.face_training import (DataGenerator, MultiBoxLoss, LossHistory, weights_init,
                                detection_collate)
...
if __name__ == "__main__":
    ...
    model = YoloBody(cfg=cfg, pretrained=pretrained,phi=3).train()
    #-------------------------------------------#
    #   权值文件的下载请看README
    #   权值和主干特征提取网络一定要对应
    #-------------------------------------------#
    model_path = "model_data/Epoch84-Total_Loss7.1897.pth"
